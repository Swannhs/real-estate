...
const PriceRangeInput: FC<PriceRangeInputProps> = ({fieldClassName = "[ nc-hero-field-padding ]",}) => {
            ...
            {({open}) => (
              ...
              <span className="block xl:text-lg font-semibold truncate">
                ...
                Choose price
                    ...
                    >
                        <Popover.Panel
                            className="absolute left-0 lg:right-0 z-30 w-full sm:min-w-[340px] max-w-sm bg-white dark:bg-neutral-800 top-full mt-3 py-5 sm:py-6 px-4 sm:px-8 rounded-3xl shadow-xl">
