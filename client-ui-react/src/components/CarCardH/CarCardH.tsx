...
const CarCardH: FC<CarCardHProps> = ({className = "", data = DEMO_DATA}) => {
    ...
    const renderSliderGallery = () => {
        return (
            <div
                className="relative w-full flex items-center justify-center md:w-72 flex-shrink-0 border-r border-neutral-100 dark:border-neutral-800">
        ...
        return (
            <div className="flex-grow p-3 sm:p-5 flex flex-col">
              ...
              <span className="hidden sm:inline-block  text-base">
                ...
                {/* SHOW MOBILE */}
                <div
                    className="flex sm:hidden items-center text-sm text-neutral-500 dark:text-neutral-400 space-x-2 mt-4 sm:mt-0">
                    <span>4 seats</span>
                    <span>· </span>
