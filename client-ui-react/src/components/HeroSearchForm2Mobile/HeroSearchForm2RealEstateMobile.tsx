                                ...
                                <Dialog.Panel
                                    ...
                                    {showDialog && (
                                        <Tab.Group manual>
                                            ...
                                            <Tab.List
                                                className="pt-12 flex w-full justify-center font-semibold text-sm sm:text-base text-neutral-500 dark:text-neutral-400 space-x-6 sm:space-x-8">
                                                    ...
                                                    <Tab key={index} as={Fragment}>
                                                        {({selected}) => (
                                                            <div
                                                                ...
                                                                {selected && (
                                                                    <span
                                                                        className="absolute inset-x-0 top-full border-b-2 border-black dark:border-white"></span>
                                                                )}
                                                            </div>
                                                        )}
                                                    </Tab>
