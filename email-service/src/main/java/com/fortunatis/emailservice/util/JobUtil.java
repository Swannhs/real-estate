package com.fortunatis.emailservice.util;

import com.fortunatis.emailservice.config.PersistableCronTriggerFactoryBean;
...
public class JobUtil {
    public static String generateUniqueJobName() {
    ...
    public static JobKey createJobKey(String jobName, String emailGroup) {
        return new JobKey(jobName, emailGroup);
    }

    public static String createTriggerKey(String jobName, String emailGroup) {
        return jobName + "_" + emailGroup;
    }
}
