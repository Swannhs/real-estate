...
import ExperiencesDateSingleInput from "@/theme-pages/(client-components)/(HeroSearchForm)/ExperiencesDateSingleInput";
import GuestsInput from "@/theme-pages/(client-components)/(HeroSearchForm)/GuestsInput";
          ...
          <span className="text-3xl font-semibold">
            ...
            <span className="ml-1 text-base font-normal text-neutral-500 dark:text-neutral-400">
              /person
                ...
                {/* FORM */}
                <form
                    className="flex flex-col sm:flex-row border divide-y sm:divide-y-0 sm:divide-x divide-neutral-200 dark:divide-neutral-700 border-neutral-200 dark:border-neutral-700 rounded-3xl ">
