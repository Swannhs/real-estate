...
import {TimeRage} from "@/theme-pages/(client-components)/(HeroSearchForm)/RentalCarSearchForm";
...
import RentalCarDatesRangeInput from "@/theme-pages/(client-components)/(HeroSearchForm)/RentalCarDatesRangeInput";
    ...
    const renderSectionTienIch = () => {
        return (
            ...
            Questions are at the heart of making things great.
                ...
                {/* 6 */}
                <div
                    className="grid grid-cols-1 lg:grid-cols-2 gap-y-6 gap-x-10 text-sm text-neutral-700 dark:text-neutral-300 ">
                    {/* TIEN ICH 1 */}
