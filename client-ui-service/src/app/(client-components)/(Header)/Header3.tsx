...
import {StaySearchFormFields} from "../(HeroSearchForm2)/StaySearchForm";
import {useLocation} from "react-use";
import HeroSearchForm2 from "../(HeroSearchForm2)/HeroSearchForm";
          ...
          ${
                ...
                <div className="relative px-4 lg:container h-[88px] flex">
                    <div className="flex-1 flex justify-between">
                        ...
                        {/* NAV */}
                        <div
                            className="hidden md:flex relative z-10 flex-1 justify-end text-neutral-700 dark:text-neutral-100">
