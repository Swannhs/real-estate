    ...
    () => [
      {
        ...
        Cell: ({ value }: { value: string }) => <Avatar alt='Avatar 1' size='sm'
                                                        src={avatarImage(`./avatar-${value}.png`)} />
      },
      {
        Header: 'Name',
        accessor: 'fatherName'
...
const ExpandingSubTable = ({ data }: { data: [] }) => {
  ...
  return (
    <MainCard title='Expanding Sub Table' content={false}
              secondary={<CSVExport data={data} filename={'expanding-sub-table.csv'} />}>
      <ScrollX>
