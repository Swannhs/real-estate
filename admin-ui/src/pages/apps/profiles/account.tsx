      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider', width: '100%' }}>
        <Tabs value={value} onChange={handleChange} variant='scrollable' scrollButtons='auto'
          ...
          <Tab label='Personal' component={Link} to='/apps/profiles/account/personal' icon={<DocumentText />}
               iconPosition='start' />
          <Tab label='My Account' component={Link} to='/apps/profiles/account/my-account' icon={<TableDocument />}
               iconPosition='start' />
          <Tab label='Change Password' component={Link} to='/apps/profiles/account/password' icon={<Lock />}
               iconPosition='start' />
          <Tab label='Role' component={Link} to='/apps/profiles/account/role' icon={<Profile2User />}
               iconPosition='start' />
          <Tab label='Settings' component={Link} to='/apps/profiles/account/settings' icon={<Setting3 />}
               iconPosition='start' />
        </Tabs>
      </Box>
      <Box sx={{ mt: 2.5 }}>
